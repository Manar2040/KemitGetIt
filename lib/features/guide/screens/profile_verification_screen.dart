...
class _ProfileVerificationScreenState extends State<ProfileVerificationScreen> {
  ...
  bool _isPicking = false; // لمنع اختيار أكثر من صورة في نفس الوقت

  Future<void> pickImage(bool isId) async {
    if (_isPicking) return; // لو فيه اختيار شغال، تجاهل الضغط
    _isPicking = true;
    ...
    try {
      ...
      _isPicking = false; // إعادة تعيين flag
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                maxLines: 4,
                decoration: InputDecoration(
                  hintText: "Tell us about your technical background and expertise...",
                  border: OutlineInputBorder(

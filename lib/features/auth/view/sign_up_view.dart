...
void initState() {
  ...
  void _onVmChanged() {
    ...
    if (vm.navTarget == AuthNavTarget.emailVerificationPending) {
      vm.consumeNavTarget();
      // Navigate to the "check your inbox" screen.
      // Replace this route so back-button does not return to signup.
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => EmailVerificationPendingView(email: vm.lastRegisteredEmail),
        ),
      );
      return;
    }

    // Legacy fallback targets (kept in case of future role-specific routing)

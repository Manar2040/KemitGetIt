...
class TripSummary {
  ...
  factory TripSummary.fromJson(Map<String, dynamic> j) => TripSummary(
    ...
    durationNights:      j['durationNights'] as int? ?? 0,
    maxParticipants:     j['maxParticipants'] as int? ?? 0,
    currentParticipants: j['currentParticipants'] as int? ?? 0,
...
class GuideReview {
  ...
  factory GuideReview.fromJson(Map<String, dynamic> j) => GuideReview(
    touristName:     j['touristName'] as String? ?? 'Anonymous',
    touristImageUrl: j['touristImageUrl'] as String?,
    rating:          (j['rating'] as num?)?.toInt() ?? (j['guideRating'] as num?)?.toInt() ?? 0,
